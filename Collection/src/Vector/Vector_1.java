...
//List 인터페이스의 두번째 구현클래스 Vector 사용범
//Vector는 멀티 쓰레드 환경에 적합한 동기화 기능을 지원
//멀티쓰레드를 수행하느느데 쓰인다면 Vector를 사용해야함
